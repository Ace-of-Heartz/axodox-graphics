...
//
//
inline ACE_GRAPHICS_API ID3D12Resource* CreateBuffer(ID3D12Device* m_device, uint64_t size,
...
//
ACE_GRAPHICS_API IDxcBlob* CompileShaderLibrary(LPCWSTR fileName)
{
...
//
//
ACE_GRAPHICS_API ID3D12DescriptorHeap* CreateDescriptorHeap(ID3D12Device* device, uint32_t count,
...
ACE_GRAPHICS_API void GenerateMengerSponge(int32_t level, float probability, std::vector<Vertex>& outputVertices,
